...
exploration of specific tests afterwards. The {\tt -a} switch should
always be combined with the {\tt -Y1} switch, to add a strategy to
overcome the Multiple Comparisons Problem.
...
popular and in widespread use back in the 70's.

Then the bad news begins.

The statistical end result, the mean p-value of 0.058426 is extremely
low.  This is calculated by taking all absolute differences of the all
the p-values from the ideal p-value 0.5.
